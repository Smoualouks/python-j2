...
with open('deniro.csv', 'r') as f:
    ...
    # je me lis le contenu du fichier csv.
...
# je récuprè l'index de film ayant le score max
index = scores.index(max(scores))

# je counte le nombre de films sorti entre [2000,2010]          
for year in years:
...
#le nombre de films sorti entre 2000 et 2010
